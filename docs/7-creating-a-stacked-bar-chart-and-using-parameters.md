...
Go to the top **Data** Menu and select **New Data Source**. Select **Excel** and choose the *RomeoAndJulietWordFrequenciesByAct.xls* file. This dataset lists word frequencies in Romeo and Juliet by Act. Make sure to check how your variables are classified – note that “Act” is classed as a numeric variable when we know it is a string. You can change this now, as we did before, but instead we will also show you how to change this later in the tutorial (in the event you didn't notice this when you initially imported your dataset into Tableau!).
